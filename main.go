...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
return ((CaloriesMeanSpeedMultiplier * r.Speed + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
((CaloriesWeightMultiplier * w.Weight + (w.Speed**2 / w.Height) * CaloriesSpeedHeightMultiplier * w.Weight) * w.Duration.Hours() * MinsInHour)
}
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	return s.LengthPool * CountPool / MInKm / s.Duration.Hours()
}
...
func ReadData(training CaloriesCalculator) string {
	...
	TrainingInfo().Calories := calories
